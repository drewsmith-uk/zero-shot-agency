---
title: "Day 108: Triage Damaging AI Answers Before You Publish a Fix"
date: 2026-08-06
slug: "day-108-triage-damaging-ai-answers-before-you-publish-a-fix"
description: "A reputation-response decision tree for CMOs, Marketing Directors, and founders: when an answer-led surface carries a commercially damaging statement, preserve the observation, classify the underlying claim state, assess consequence and recurrence, then choose the smallest proportionate response without amplifying the harm."
categories:
  - Build in Public
...
1. Is the statement current and accurate?
   - Do not publish a denial. Decide whether the business wants to change the underlying condition, explain the boundary more clearly, equip sales, or accept that the statement is a fair constraint.

2. Is it true but outdated?
...
3. Is it misleading because context is missing?
   - Publish a bounded clarification only if the missing context is useful to buyers. Say what is true, where it applies, and where it does not. Avoid repeating the damaging phrasing as the headline of the correction.

4. Is it disputed, sensitive, or unclear?
   - Route to communications, legal, compliance, product, delivery, sales, or leadership before any public action. Marketing should preserve the observation and commercial consequence, not improvise a verdict.

5. Is it false or unsupported?
   - Preserve the evidence, check source visibility, remove or correct any owned material that accidentally supports the claim, and consider a narrow public clarification if a buyer genuinely needs it. Do not promise that the answer will disappear.

6. Is the observation isolated and low consequence?
